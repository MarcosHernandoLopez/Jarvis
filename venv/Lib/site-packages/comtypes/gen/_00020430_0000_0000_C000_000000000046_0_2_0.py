...
IFontDisp = Font
__all__ = [ 'LoadPictureConstants', 'OLE_HANDLE', 'Gray',
           'FONTUNDERSCORE', 'OLE_XSIZE_CONTAINER', 'Unchecked',
           'OLE_XSIZE_HIMETRIC', 'Checked', 'Monochrome',
           'OLE_TRISTATE', 'FontEvents', 'OLE_YSIZE_CONTAINER',
           'IFontEventsDisp', 'FONTSTRIKETHROUGH', 'FONTITALIC',
           'Default', 'VgaColor', 'OLE_ENABLEDEFAULTBOOL', 'FONTBOLD',
           'OLE_YSIZE_HIMETRIC', 'FONTNAME', 'Font', 'IPicture',
           'Color', 'Picture', 'OLE_OPTEXCLUSIVE',
           'OLE_XPOS_HIMETRIC', 'IPictureDisp', 'StdFont',
           'IFontDisp', 'OLE_XSIZE_PIXELS', 'OLE_COLOR',
           'OLE_CANCELBOOL', 'FONTSIZE', 'OLE_XPOS_PIXELS',
           'StdPicture', 'OLE_YPOS_CONTAINER', 'OLE_XPOS_CONTAINER',
           'OLE_YPOS_HIMETRIC', 'IFont', 'OLE_YSIZE_PIXELS',
           'OLE_YPOS_PIXELS']
